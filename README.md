...
class NitinGA:
    def __init__(self):
        ...
        self.cgpa         = 8.43
        self.role         = "Aspiring Data Scientist & Full-Stack Dev"
...
|:-------|:------------|:--------:|:-----:|
| B.Tech – Computer Science & Information Technology | Reva University, Bangalore | Oct 2023 – 2027 | CGPA: **8.43** |
